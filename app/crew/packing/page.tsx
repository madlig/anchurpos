            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="h-12 bg-slate-50 rounded-xl border border-slate-200 flex items-center px-4 text-sm font-bold text-slate-700">
              ...
              {parseInt(regularPacksToUnpack) > 0 && (
                <div className="p-4 bg-slate-50 border border-slate-100 rounded-2xl text-xs space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-xs font-bold pt-2 border-t border-slate-200">
                    <div className="flex-1 p-2 bg-pink-50 border border-pink-100 rounded-lg text-center text-pink-700">
                      <p className="text-[9px] uppercase text-pink-400 font-extrabold tracking-wider">Pack Full Dihasilkan</p>
                    ...
                    <div className="flex-1 p-2 bg-slate-100 border border-slate-200 rounded-lg text-center text-slate-600">
                      <p className="text-[9px] uppercase text-slate-400 font-extrabold tracking-wider">Sisa Buffer Baru</p>
